...
func _process(delta):
	if get_tree().get_first_node_in_group("FlightScreen").game_over or get_tree().get_first_node_in_group("FlightScreen").game_won or get_tree().get_first_node_in_group("FlightScreen").height < 3000:
		return
